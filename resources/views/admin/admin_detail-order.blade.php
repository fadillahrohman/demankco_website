                    ...
                    <table class="min-w-full table-auto">
                        <tbody>
                            ...
                            <tr class="border-b border-dashed border-gray-300">
                                ...
                                <td class="font-semibold text-gray-700 py-2 flex items-center">
                                    <span id="receipt-text">{{ $order->receipt }}</span>
                                    <button onclick="copyToClipboard()"
                                        class="ml-2 bg-[#3FAFF3] text-white text-sm px-2 py-1 rounded hover:bg-blue-500 transition duration-300">
