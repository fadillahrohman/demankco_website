    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-9">
        ...
        <div class="bg-white rounded-lg p-4 border-solid border-2 border-gray-200">
            @forelse($orders as $ordercoy)
                @if ($ordercoy->payment_status !== 'unpaid')
                    <div class="flex flex-col md:flex-row items-center justify-between pb-4 mb-4 border-gray-300 relative">
                        ...
                        <div class="flex space-x-4 mt-4 md:mt-0">
                            ...
                            <div class="relative">
                                ...
                                <div
                                    class="absolute z-20 right-0 mt-2 w-48 bg-white border border-gray-200 rounded shadow-lg hidden">
                                    <a href="" class="block px-4 py-2 text-gray-800 hover:bg-gray-100"
                                        onclick="ubahStatusPesanan('{{ $ordercoy->id }}', 'processing')">Sedang Diproses</a>
                                    <a href="" class="block px-4 py-2 text-gray-800 hover:bg-gray-100"
                                        onclick="ubahStatusPesanan('{{ $ordercoy->id }}', 'completed')">Selesai</a>
                                    <a href="" class="block px-4 py-2 text-gray-800 hover:bg-gray-100"
                                        onclick="ubahStatusPesanan('{{ $ordercoy->id }}', 'shipped')">Dikirim</a>
                                    <a href="" class="block px-4 py-2 text-gray-800 hover:bg-gray-100"
                                        onclick="ubahStatusPesanan('{{ $ordercoy->id }}', 'cancelled')">Dibatalkan</a>
                                </div>
                            </div>
                        </div>
                        <!-- Status section -->
