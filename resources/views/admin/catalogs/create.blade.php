...
<head>
    ...
    <title>Tambah Katalog - DMCO</title>
        ...
        <div class="max-w-4xl mx-auto mt-6">
            <div class="bg-white shadow-lg rounded-lg">
                <div class="bg-gray-800 p-4 rounded-t-lg">
                    <h3 class="text-white text-xl font-semibold">Katalog (Add)</h3>
                </div>
                <form enctype="multipart/form-data" action="{{ route('admin.catalogs.store') }}" method="POST">
                    @csrf
                    <div class="p-6">
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <select id="type" name="type"
                                ...
                                <option value="" disabled selected>Pilih Tipe Katalog</option>
                                <option value="Tshirt" {{ old('type') == 'tshirt' ? 'selected' : '' }}>T-shirt</option>
                                <option value="Crewneck" {{ old('type') == 'crewneck' ? 'selected' : '' }}>Crewneck</option>
